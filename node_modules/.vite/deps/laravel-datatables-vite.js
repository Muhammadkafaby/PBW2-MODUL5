...
var require_jquery = __commonJS({
  "node_modules/jquery/dist/jquery.js"(exports, module) {
    (function(global, factory) {
      ...
      var version = "3.7.1", rhtmlSuffix = /HTML$/i, jQuery7 = function(selector, context) {
        return new jQuery7.fn.init(selector, context);
      };
      jQuery7.fn = jQuery7.prototype = {
        ...
        pushStack: function(elems) {
          var ret = jQuery7.merge(this.constructor(), elems);
          ret.prevObject = this;
          return ret;
        },
        // Execute a callback for every element in the matched set.
        each: function(callback) {
          return jQuery7.each(this, callback);
        },
        map: function(callback) {
          return this.pushStack(jQuery7.map(this, function(elem, i2) {
        ...
        even: function() {
          return this.pushStack(jQuery7.grep(this, function(_elem, i2) {
            return (i2 + 1) % 2;
          }));
        },
        odd: function() {
      ...
      jQuery7.extend = jQuery7.fn.extend = function() {
        ...
        for (; i2 < length; i2++) {
          if ((options = arguments[i2]) != null) {
            for (name in options) {
              ...
              if (deep && copy && (jQuery7.isPlainObject(copy) || (copyIsArray = Array.isArray(copy)))) {
                src = target[name];
                if (copyIsArray && !Array.isArray(src)) {
                  clone = [];
                } else if (!copyIsArray && !jQuery7.isPlainObject(src)) {
                  clone = {};
                } else {
                  clone = src;
                }
                copyIsArray = false;
                target[name] = jQuery7.extend(deep, clone, copy);
              } else if (copy !== void 0) {
                target[name] = copy;
              }
            }
      ...
      if (typeof Symbol === "function") {
        jQuery7.fn[Symbol.iterator] = arr[Symbol.iterator];
      }
      jQuery7.each(
      ...
      jQuery7.escapeSelector = function(sel) {
        return (sel + "").replace(rcssescape, fcssescape);
      };
      var preferredDoc = document2, pushNative = push;
      (function() {
        var i2, Expr, outermostContext, sortInput, hasDuplicate, push2 = pushNative, document3, documentElement2, documentIsHTML, rbuggyQSA, matches, expando = jQuery7.expando, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
          if (a === b) {
            hasDuplicate = true;
          }
          return 0;
                ...
                if (nodeType === 1 && (rdescend.test(selector) || rleadingCombinator.test(selector))) {
                  ...
                  if (newContext != context || !support.scope) {
                    if (nid = context.getAttribute("id")) {
                      nid = jQuery7.escapeSelector(nid);
                    } else {
        ...
        function setDocument(node) {
          ...
          documentIsHTML = !jQuery7.isXMLDoc(document3);
          ...
          support.getById = assert(function(el) {
            documentElement2.appendChild(el).id = jQuery7.expando;
            return !document3.getElementsByName || !document3.getElementsByName(jQuery7.expando).length;
          });
        ...
        find.contains = function(context, elem) {
          ...
          return jQuery7.contains(context, elem);
        };
        ...
        jQuery7.uniqueSort = function(results) {
        ...
        jQuery7.fn.uniqueSort = function() {
          return this.pushStack(jQuery7.uniqueSort(slice.apply(this)));
        };
        Expr = jQuery7.expr = {
          ...
          pseudos: {
            ...
            contains: markFunction(function(text) {
              ...
              return function(elem) {
                return (elem.textContent || jQuery7.text(elem)).indexOf(text) > -1;
              };
            }),
        ...
        jQuery7.find = find;
        jQuery7.expr[":"] = jQuery7.expr.pseudos;
        jQuery7.unique = jQuery7.uniqueSort;
        find.compile = compile;
        find.select = select;
        find.setDocument = setDocument;
        find.tokenize = tokenize;
        find.escape = jQuery7.escapeSelector;
        find.getText = jQuery7.text;
        find.isXML = jQuery7.isXMLDoc;
        find.selectors = jQuery7.expr;
        find.support = jQuery7.support;
        find.uniqueSort = jQuery7.uniqueSort;
      })();
      var dir = function(elem, dir2, until) {
        var matched = [], truncate = until !== void 0;
        while ((elem = elem[dir2]) && elem.nodeType !== 9) {
          if (elem.nodeType === 1) {
            if (truncate && jQuery7(elem).is(until)) {
              break;
            }
            matched.push(elem);
          }
      ...
      var rneedsContext = jQuery7.expr.match.needsContext;
      var rsingleTag = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
      function winnow(elements, qualifier, not) {
        if (isFunction(qualifier)) {
          return jQuery7.grep(elements, function(elem, i2) {
            return !!qualifier.call(elem, i2, elem) !== not;
          });
        }
        if (qualifier.nodeType) {
          return jQuery7.grep(elements, function(elem) {
        ...
        return jQuery7.filter(qualifier, elements, not);
      }
      jQuery7.filter = function(expr, elems, not) {
        var elem = elems[0];
        if (not) {
          expr = ":not(" + expr + ")";
        }
        if (elems.length === 1 && elem.nodeType === 1) {
          return jQuery7.find.matchesSelector(elem, expr) ? [elem] : [];
        }
        return jQuery7.find.matches(expr, jQuery7.grep(elems, function(elem2) {
      ...
      jQuery7.fn.extend({
        find: function(selector) {
          ...
          if (typeof selector !== "string") {
            return this.pushStack(jQuery7(selector).filter(function() {
              for (i2 = 0; i2 < len; i2++) {
                if (jQuery7.contains(self[i2], this)) {
                  return true;
                }
              }
            }));
          ...
          ret = this.pushStack([]);
          for (i2 = 0; i2 < len; i2++) {
            jQuery7.find(selector, self[i2], ret);
          }
          return len > 1 ? jQuery7.uniqueSort(ret) : ret;
        },
        ...
        is: function(selector) {
          return !!winnow(
            ...
            typeof selector === "string" && rneedsContext.test(selector) ? jQuery7(selector) : selector || [],
            false
          ).length;
        }
      });
      var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init2 = jQuery7.fn.init = function(selector, context, root) {
        var match, elem;
        if (!selector) {
          return this;
        }
        ...
        if (typeof selector === "string") {
          ...
          if (match && (match[1] || !context)) {
            if (match[1]) {
              context = context instanceof jQuery7 ? context[0] : context;
              jQuery7.merge(this, jQuery7.parseHTML(
                match[1],
                context && context.nodeType ? context.ownerDocument || context : document2,
                true
              ));
              if (rsingleTag.test(match[1]) && jQuery7.isPlainObject(context)) {
        ...
        return jQuery7.makeArray(selector, this);
      };
      init2.prototype = jQuery7.fn;
      rootjQuery = jQuery7(document2);
      ...
      jQuery7.fn.extend({
        has: function(target) {
          var targets = jQuery7(target, this), l = targets.length;
          return this.filter(function() {
            var i2 = 0;
            for (; i2 < l; i2++) {
              if (jQuery7.contains(this, targets[i2])) {
                return true;
              }
            }
          });
        ...
        closest: function(selectors, context) {
          var cur, i2 = 0, l = this.length, matched = [], targets = typeof selectors !== "string" && jQuery7(selectors);
          if (!rneedsContext.test(selectors)) {
            for (; i2 < l; i2++) {
              for (cur = this[i2]; cur && cur !== context; cur = cur.parentNode) {
                if (cur.nodeType < 11 && (targets ? targets.index(cur) > -1 : (
                  // Don't pass non-elements to jQuery#find
                  cur.nodeType === 1 && jQuery7.find.matchesSelector(cur, selectors)
                ))) {
                  matched.push(cur);
                  break;
                }
          ...
          return this.pushStack(matched.length > 1 ? jQuery7.uniqueSort(matched) : matched);
        },
        ...
        index: function(elem) {
          ...
          if (typeof elem === "string") {
            return indexOf.call(jQuery7(elem), this[0]);
          }
          return indexOf.call(
            this,
        ...
        add: function(selector, context) {
          return this.pushStack(
            jQuery7.uniqueSort(
              jQuery7.merge(this.get(), jQuery7(selector, context))
            )
          );
        },
      ...
      jQuery7.each({
        ...
        contents: function(elem) {
          ...
          return jQuery7.merge([], elem.childNodes);
        }
      }, function(name, fn) {
        jQuery7.fn[name] = function(until, selector) {
          var matched = jQuery7.map(this, fn, until);
          if (name.slice(-5) !== "Until") {
            selector = until;
          }
          if (selector && typeof selector === "string") {
            matched = jQuery7.filter(selector, matched);
          }
          if (this.length > 1) {
            if (!guaranteedUnique[name]) {
              jQuery7.uniqueSort(matched);
            }
      ...
      function createOptions(options) {
        var object = {};
        jQuery7.each(options.match(rnothtmlwhite) || [], function(_, flag) {
          object[flag] = true;
        });
        return object;
      }
      jQuery7.Callbacks = function(options) {
        options = typeof options === "string" ? createOptions(options) : jQuery7.extend({}, options);
        var firing, memory, fired, locked, list = [], queue = [], firingIndex = -1, fire = function() {
          ...
          add: function() {
            if (list) {
              ...
              (function add(args) {
                jQuery7.each(args, function(_, arg) {
                  if (isFunction(arg)) {
          ...
          remove: function() {
            jQuery7.each(arguments, function(_, arg) {
              var index;
              while ((index = jQuery7.inArray(arg, list, index)) > -1) {
                list.splice(index, 1);
          ...
          has: function(fn) {
            return fn ? jQuery7.inArray(fn, list) > -1 : list.length > 0;
          },
      ...
      jQuery7.extend({
        Deferred: function(func) {
          var tuples = [
            ...
            pipe: function() {
              var fns = arguments;
              return jQuery7.Deferred(function(newDefer) {
                jQuery7.each(tuples, function(_i, tuple) {
                ...
                return function() {
                  var that = this, args = arguments, mightThrow = function() {
                    ...
                    try {
                      ...
                      if (jQuery7.Deferred.exceptionHook) {
                        jQuery7.Deferred.exceptionHook(
                          e,
                          process.error
                        );
                      }
                  ...
                  if (depth) {
                    ...
                    if (jQuery7.Deferred.getErrorHook) {
                      process.error = jQuery7.Deferred.getErrorHook();
                    } else if (jQuery7.Deferred.getStackHook) {
                      process.error = jQuery7.Deferred.getStackHook();
                    }
            ...
            promise: function(obj) {
              return obj != null ? jQuery7.extend(obj, promise) : promise;
            }
          }, deferred = {};
          jQuery7.each(tuples, function(i2, tuple) {
        ...
        when: function(singleValue) {
          var remaining = arguments.length, i2 = remaining, resolveContexts = Array(i2), resolveValues = slice.call(arguments), primary = jQuery7.Deferred(), updateFunc = function(i3) {
      ...
      jQuery7.Deferred.exceptionHook = function(error, asyncError) {
      ...
      jQuery7.readyException = function(error) {
        window2.setTimeout(function() {
          throw error;
        });
      };
      var readyList = jQuery7.Deferred();
      jQuery7.fn.ready = function(fn) {
        readyList.then(fn).catch(function(error) {
          jQuery7.readyException(error);
        });
        return this;
      };
      jQuery7.extend({
        ...
        ready: function(wait) {
          if (wait === true ? --jQuery7.readyWait : jQuery7.isReady) {
            return;
          }
          jQuery7.isReady = true;
          if (wait !== true && --jQuery7.readyWait > 0) {
            return;
          }
          readyList.resolveWith(document2, [jQuery7]);
        }
      });
      jQuery7.ready.then = readyList.then;
      function completed() {
      ...
      if (document2.readyState === "complete" || document2.readyState !== "loading" && !document2.documentElement.doScroll) {
        window2.setTimeout(jQuery7.ready);
      } else {
          ...
          if (bulk) {
            if (raw) {
              ...
              fn = function(elem, _key, value2) {
                return bulk.call(jQuery7(elem), value2);
              };
            }
          }
          if (fn) {
      ...
      function Data() {
        this.expando = jQuery7.expando + Data.uid++;
      }
      Data.uid = 1;
      Data.prototype = {
        ...
        remove: function(owner, key) {
          ...
          if (key === void 0 || jQuery7.isEmptyObject(cache)) {
            if (owner.nodeType) {
        ...
        hasData: function(owner) {
          ...
          return cache !== void 0 && !jQuery7.isEmptyObject(cache);
        }
      };
      ...
      jQuery7.extend({
          ...
          if (elem) {
            ...
            if (data) {
              if (!queue || Array.isArray(data)) {
                queue = dataPriv.access(elem, type, jQuery7.makeArray(data));
              } else {
                queue.push(data);
              }
            }
        ...
        dequeue: function(elem, type) {
          type = type || "fx";
          var queue = jQuery7.queue(elem, type), startLength = queue.length, fn = queue.shift(), hooks = jQuery7._queueHooks(elem, type), next = function() {
            jQuery7.dequeue(elem, type);
          };
          if (fn === "inprogress") {
            fn = queue.shift();
            startLength--;
        ...
        _queueHooks: function(elem, type) {
          ...
          return dataPriv.get(elem, key) || dataPriv.access(elem, key, {
            empty: jQuery7.Callbacks("once memory").add(function() {
      ...
      jQuery7.fn.extend({
        queue: function(type, data) {
          ...
          if (arguments.length < setter) {
            return jQuery7.queue(this[0], type);
          }
          return data === void 0 ? this : this.each(function() {
            var queue = jQuery7.queue(this, type, data);
            jQuery7._queueHooks(this, type);
            if (type === "fx" && queue[0] !== "inprogress") {
              jQuery7.dequeue(this, type);
            }
          });
        },
        ...
        promise: function(type, obj) {
          var tmp, count = 1, defer = jQuery7.Deferred(), elements = this, i2 = this.length, resolve = function() {
            if (!--count) {
      ...
      var isAttached = function(elem) {
        return jQuery7.contains(elem.ownerDocument, elem);
      }, composed = { composed: true };
      if (documentElement.getRootNode) {
        isAttached = function(elem) {
          return jQuery7.contains(elem.ownerDocument, elem) || elem.getRootNode(composed) === elem.ownerDocument;
        };
      }
      var isHiddenWithinTree = function(elem, el) {
        ...
        // in the document.
        isAttached(elem) && jQuery7.css(elem, "display") === "none";
      };
      function adjustCSS(elem, prop, valueParts, tween) {
        var adjusted, scale, maxIterations = 20, currentValue = tween ? function() {
          return tween.cur();
        } : function() {
          return jQuery7.css(elem, prop, "");
        }, initial = currentValue(), unit = valueParts && valueParts[3] || (jQuery7.cssNumber[prop] ? "" : "px"), initialInUnit = elem.nodeType && (jQuery7.cssNumber[prop] || unit !== "px" && +initial) && rcssNum.exec(jQuery7.css(elem, prop));
        if (initialInUnit && initialInUnit[3] !== unit) {
          initial = initial / 2;
          unit = unit || initialInUnit[3];
          initialInUnit = +initial || 1;
          while (maxIterations--) {
            jQuery7.style(elem, prop, initialInUnit + unit);
      ...
      function getDefaultDisplay(elem) {
        ...
        display = jQuery7.css(temp, "display");
      ...
      function getAll(context, tag) {
        ...
        if (tag === void 0 || tag && nodeName(context, tag)) {
          return jQuery7.merge([context], ret);
        }
        return ret;
      }
      ...
      function buildFragment(elems, context, scripts, selection, ignored) {
        ...
        for (; i2 < l; i2++) {
          ...
          if (elem || elem === 0) {
            if (toType(elem) === "object") {
              jQuery7.merge(nodes, elem.nodeType ? [elem] : elem);
              ...
              tmp.innerHTML = wrap[1] + jQuery7.htmlPrefilter(elem) + wrap[2];
              j = wrap[0];
              while (j--) {
                tmp = tmp.lastChild;
              }
              jQuery7.merge(nodes, tmp.childNodes);
        ...
        i2 = 0;
        while (elem = nodes[i2++]) {
          if (selection && jQuery7.inArray(elem, selection) > -1) {
            if (ignored) {
              ignored.push(elem);
            }
            continue;
      ...
      function on(elem, types, selector, data, fn, one) {
        ...
        if (one === 1) {
          ...
          fn.guid = origFn.guid || (origFn.guid = jQuery7.guid++);
        }
        return elem.each(function() {
          jQuery7.event.add(this, types, fn, data, selector);
        });
      }
      jQuery7.event = {
        global: {},
        add: function(elem, types, handler, data, selector) {
          ...
          if (selector) {
            jQuery7.find.matchesSelector(documentElement, selector);
          }
          if (!handler.guid) {
            handler.guid = jQuery7.guid++;
          }
          ...
          if (!(eventHandle = elemData.handle)) {
            eventHandle = elemData.handle = function(e) {
              return typeof jQuery7 !== "undefined" && jQuery7.event.triggered !== e.type ? jQuery7.event.dispatch.apply(elem, arguments) : void 0;
            };
          }
          ...
          while (t--) {
            ...
            special = jQuery7.event.special[type] || {};
            type = (selector ? special.delegateType : special.bindType) || type;
            special = jQuery7.event.special[type] || {};
            handleObj = jQuery7.extend({
              type,
              origType,
              data,
              handler,
              guid: handler.guid,
              selector,
              needsContext: selector && jQuery7.expr.match.needsContext.test(selector),
            ...
            jQuery7.event.global[type] = true;
          }
        },
        ...
        remove: function(elem, types, handler, selector, mappedTypes) {
          ...
          while (t--) {
            ...
            if (!type) {
              for (type in events) {
                jQuery7.event.remove(elem, type + types[t], handler, selector, true);
              }
              continue;
            }
            special = jQuery7.event.special[type] || {};
            ...
            if (origCount && !handlers.length) {
              if (!special.teardown || special.teardown.call(elem, namespaces, elemData.handle) === false) {
                jQuery7.removeEvent(elem, type, elemData.handle);
              }
              delete events[type];
            }
          }
          if (jQuery7.isEmptyObject(events)) {
            dataPriv.remove(elem, "handle events");
          }
        },
        dispatch: function(nativeEvent) {
          var i2, j, ret, matched, handleObj, handlerQueue, args = new Array(arguments.length), event = jQuery7.event.fix(nativeEvent), handlers = (dataPriv.get(this, "events") || /* @__PURE__ */ Object.create(null))[event.type] || [], special = jQuery7.event.special[event.type] || {};
          args[0] = event;
          ...
          handlerQueue = jQuery7.event.handlers.call(this, event, handlers);
          i2 = 0;
          while ((matched = handlerQueue[i2++]) && !event.isPropagationStopped()) {
            ...
            while ((handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped()) {
              if (!event.rnamespace || handleObj.namespace === false || event.rnamespace.test(handleObj.namespace)) {
                ...
                ret = ((jQuery7.event.special[handleObj.origType] || {}).handle || handleObj.handler).apply(matched.elem, args);
                if (ret !== void 0) {
              ...
              if (cur.nodeType === 1 && !(event.type === "click" && cur.disabled === true)) {
                ...
                for (i2 = 0; i2 < delegateCount; i2++) {
                  ...
                  if (matchedSelectors[sel] === void 0) {
                    matchedSelectors[sel] = handleObj.needsContext ? jQuery7(sel, this).index(cur) > -1 : jQuery7.find(sel, this, null, [cur]).length;
                  }
        ...
        addProp: function(name, hook) {
          Object.defineProperty(jQuery7.Event.prototype, name, {
            enumerable: true,
            configurable: true,
        ...
        fix: function(originalEvent) {
          return originalEvent[jQuery7.expando] ? originalEvent : new jQuery7.Event(originalEvent);
        },
        special: {
          load: {
      ...
      function leverageNative(el, type, isSetup) {
        if (!isSetup) {
          if (dataPriv.get(el, type) === void 0) {
            jQuery7.event.add(el, type, returnTrue);
          }
          return;
        }
        dataPriv.set(el, type, false);
        jQuery7.event.add(el, type, {
          namespace: false,
          handler: function(event) {
            ...
            if (event.isTrigger & 1 && this[type]) {
              ...
              } else if ((jQuery7.event.special[type] || {}).delegateType) {
                event.stopPropagation();
              }
            } else if (saved) {
              dataPriv.set(this, type, jQuery7.event.trigger(
                saved[0],
                saved.slice(1),
                this
              ));
      ...
      jQuery7.removeEvent = function(elem, type, handle) {
        if (elem.removeEventListener) {
          elem.removeEventListener(type, handle);
        }
      };
      jQuery7.Event = function(src, props) {
        if (!(this instanceof jQuery7.Event)) {
          return new jQuery7.Event(src, props);
        }
        if (src && src.type) {
        ...
        if (props) {
          jQuery7.extend(this, props);
        }
        this.timeStamp = src && src.timeStamp || Date.now();
        this[jQuery7.expando] = true;
      };
      jQuery7.Event.prototype = {
        constructor: jQuery7.Event,
      ...
      jQuery7.each({
        ...
        touches: true,
        which: true
      }, jQuery7.event.addProp);
      jQuery7.each({ focus: "focusin", blur: "focusout" }, function(type, delegateType) {
        function focusMappedHandler(nativeEvent) {
          if (document2.documentMode) {
            var handle = dataPriv.get(this, "handle"), event = jQuery7.event.fix(nativeEvent);
            ...
            jQuery7.event.simulate(
              delegateType,
              nativeEvent.target,
              jQuery7.event.fix(nativeEvent)
            );
          }
        }
        jQuery7.event.special[type] = {
        ...
        jQuery7.event.special[delegateType] = {
          setup: function() {
      ...
      jQuery7.each({
        ...
        jQuery7.event.special[orig] = {
          delegateType: fix,
          bindType: fix,
          handle: function(event) {
            var ret, target = this, related = event.relatedTarget, handleObj = event.handleObj;
            if (!related || related !== target && !jQuery7.contains(target, related)) {
      ...
      jQuery7.fn.extend({
        ...
        off: function(types, selector, fn) {
          ...
          if (types && types.preventDefault && types.handleObj) {
            ...
            jQuery7(types.delegateTarget).off(
          ...
          return this.each(function() {
            jQuery7.event.remove(this, types, fn, selector);
          });
        }
      });
      ...
      function manipulationTarget(elem, content) {
        if (nodeName(elem, "table") && nodeName(content.nodeType !== 11 ? content : content.firstChild, "tr")) {
          return jQuery7(elem).children("tbody")[0] || elem;
        }
        return elem;
      }
      ...
      function cloneCopyEvent(src, dest) {
          ...
          if (events) {
            ...
            for (type in events) {
              for (i2 = 0, l = events[type].length; i2 < l; i2++) {
                jQuery7.event.add(dest, type, events[type][i2]);
              }
            }
          }
        }
        if (dataUser.hasData(src)) {
          ...
          udataCur = jQuery7.extend({}, udataOld);
      ...
      function domManip(collection, args, callback, ignored) {
        ...
        if (l) {
          ...
          if (first || ignored) {
            scripts = jQuery7.map(getAll(fragment, "script"), disableScript);
            hasScripts = scripts.length;
            for (; i2 < l; i2++) {
              node = fragment;
              if (i2 !== iNoClone) {
                node = jQuery7.clone(node, true, true);
                if (hasScripts) {
                  jQuery7.merge(scripts, getAll(node, "script"));
                }
              }
            ...
            if (hasScripts) {
              ...
              jQuery7.map(scripts, restoreScript);
              for (i2 = 0; i2 < hasScripts; i2++) {
                node = scripts[i2];
                if (rscriptType.test(node.type || "") && !dataPriv.access(node, "globalEval") && jQuery7.contains(doc, node)) {
                  if (node.src && (node.type || "").toLowerCase() !== "module") {
                    if (jQuery7._evalUrl && !node.noModule) {
                      jQuery7._evalUrl(node.src, {
      ...
      function remove(elem, selector, keepData) {
        var node, nodes = selector ? jQuery7.filter(selector, elem) : elem, i2 = 0;
        for (; (node = nodes[i2]) != null; i2++) {
          if (!keepData && node.nodeType === 1) {
            jQuery7.cleanData(getAll(node));
          }
          if (node.parentNode) {
      ...
      jQuery7.extend({
        ...
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
          ...
          if (!support.noCloneChecked && (elem.nodeType === 1 || elem.nodeType === 11) && !jQuery7.isXMLDoc(elem)) {
        ...
        cleanData: function(elems) {
          var data, elem, type, special = jQuery7.event.special, i2 = 0;
              ...
              if (data = elem[dataPriv.expando]) {
                if (data.events) {
                  for (type in data.events) {
                    if (special[type]) {
                      jQuery7.event.remove(elem, type);
                    } else {
                      jQuery7.removeEvent(elem, type, data.handle);
                    }
                  }
                }
      ...
      jQuery7.fn.extend({
        ...
        text: function(value) {
          return access(this, function(value2) {
            return value2 === void 0 ? jQuery7.text(this) : this.empty().each(function() {
        ...
        empty: function() {
          ...
          for (; (elem = this[i2]) != null; i2++) {
            if (elem.nodeType === 1) {
              jQuery7.cleanData(getAll(elem, false));
              elem.textContent = "";
            }
          }
          return this;
        ...
        clone: function(dataAndEvents, deepDataAndEvents) {
          ...
          return this.map(function() {
            return jQuery7.clone(this, dataAndEvents, deepDataAndEvents);
          });
        },
        html: function(value) {
          return access(this, function(value2) {
            ...
            if (typeof value2 === "string" && !rnoInnerhtml.test(value2) && !wrapMap[(rtagName.exec(value2) || ["", ""])[1].toLowerCase()]) {
              value2 = jQuery7.htmlPrefilter(value2);
              try {
                for (; i2 < l; i2++) {
                  elem = this[i2] || {};
                  if (elem.nodeType === 1) {
        ...
        replaceWith: function() {
          ...
          return domManip(this, arguments, function(elem) {
            ...
            if (jQuery7.inArray(this, ignored) < 0) {
              jQuery7.cleanData(getAll(this));
              if (parent) {
      ...
      jQuery7.each({
        ...
        jQuery7.fn[name] = function(selector) {
          var elems, ret = [], insert = jQuery7(selector), last = insert.length - 1, i2 = 0;
          for (; i2 <= last; i2++) {
            elems = i2 === last ? this : this.clone(true);
            jQuery7(insert[i2])[original](elems);
      ...
      function finalPropName(name) {
        var final = jQuery7.cssProps[name] || vendorProps[name];
        if (final) {
          return final;
        }
        if (name in emptyStyle) {
      ...
      function boxModelAdjustment(elem, dimension, box, isBorderBox, styles, computedVal) {
        ...
        for (; i2 < 4; i2 += 2) {
          if (box === "margin") {
            marginDelta += jQuery7.css(elem, box + cssExpand[i2], true, styles);
          }
          if (!isBorderBox) {
            delta += jQuery7.css(elem, "padding" + cssExpand[i2], true, styles);
            if (box !== "padding") {
              delta += jQuery7.css(elem, "border" + cssExpand[i2] + "Width", true, styles);
            } else {
              extra += jQuery7.css(elem, "border" + cssExpand[i2] + "Width", true, styles);
            }
          } else {
            if (box === "content") {
              delta -= jQuery7.css(elem, "padding" + cssExpand[i2], true, styles);
      ...
      function getWidthOrHeight(elem, dimension, extra) {
        var styles = getStyles(elem), boxSizingNeeded = !support.boxSizingReliable() || extra, isBorderBox = boxSizingNeeded && jQuery7.css(elem, "boxSizing", false, styles) === "border-box", valueIsBorderBox = isBorderBox, val = curCSS(elem, dimension, styles), offsetProp = "offset" + dimension[0].toUpperCase() + dimension.slice(1);
        ...
        !parseFloat(val) && jQuery7.css(elem, "display", false, styles) === "inline") && // Make sure the element is visible & connected
        elem.getClientRects().length) {
          isBorderBox = jQuery7.css(elem, "boxSizing", false, styles) === "border-box";
      ...
      jQuery7.extend({
        ...
        style: function(elem, name, value, extra) {
          ...
          hooks = jQuery7.cssHooks[name] || jQuery7.cssHooks[origName];
          if (value !== void 0) {
            type = typeof value;
            ...
            if (type === "number" && !isCustomProp) {
              value += ret && ret[3] || (jQuery7.cssNumber[origName] ? "" : "px");
            }
      ...
      jQuery7.each(["height", "width"], function(_i, dimension) {
        jQuery7.cssHooks[dimension] = {
          get: function(elem, computed, extra) {
            if (computed) {
              return rdisplayswap.test(jQuery7.css(elem, "display")) && // Support: Safari 8+
          ...
          set: function(elem, value, extra) {
            var matches, styles = getStyles(elem), scrollboxSizeBuggy = !support.scrollboxSize() && styles.position === "absolute", boxSizingNeeded = scrollboxSizeBuggy || extra, isBorderBox = boxSizingNeeded && jQuery7.css(elem, "boxSizing", false, styles) === "border-box", subtract = extra ? boxModelAdjustment(
              elem,
              dimension,
              extra,
              isBorderBox,
            ...
            if (subtract && (matches = rcssNum.exec(value)) && (matches[3] || "px") !== "px") {
              ...
              value = jQuery7.css(elem, dimension);
            }
            return setPositiveNumber(elem, value, subtract);
          }
        };
      });
      jQuery7.cssHooks.marginLeft = addGetHookIf(
      ...
      jQuery7.each({
        ...
        jQuery7.cssHooks[prefix + suffix] = {
        ...
        if (prefix !== "margin") {
          jQuery7.cssHooks[prefix + suffix].set = setPositiveNumber;
        }
      });
      jQuery7.fn.extend({
        css: function(name, value) {
          return access(this, function(elem, name2, value2) {
            ...
            if (Array.isArray(name2)) {
              ...
              len = name2.length;
              for (; i2 < len; i2++) {
                map[name2[i2]] = jQuery7.css(elem, name2[i2], false, styles);
              }
              return map;
            }
            return value2 !== void 0 ? jQuery7.style(elem, name2, value2) : jQuery7.css(elem, name2);
      ...
      Tween.prototype = {
        ...
        init: function(elem, options, prop, end, easing, unit) {
          this.elem = elem;
          this.prop = prop;
          this.easing = easing || jQuery7.easing._default;
          this.options = options;
          this.start = this.now = this.cur();
          this.end = end;
          this.unit = unit || (jQuery7.cssNumber[prop] ? "" : "px");
        },
        cur: function() {
        ...
        run: function(percent) {
          ...
          if (this.options.duration) {
            this.pos = eased = jQuery7.easing[this.easing](
              percent,
      ...
      Tween.propHooks = {
        _default: {
          get: function(tween) {
            ...
            result = jQuery7.css(tween.elem, tween.prop, "");
            return !result || result === "auto" ? 0 : result;
          },
          set: function(tween) {
            if (jQuery7.fx.step[tween.prop]) {
              jQuery7.fx.step[tween.prop](tween);
            } else if (tween.elem.nodeType === 1 && (jQuery7.cssHooks[tween.prop] || tween.elem.style[finalPropName(tween.prop)] != null)) {
              jQuery7.style(tween.elem, tween.prop, tween.now + tween.unit);
            } else {
      ...
      jQuery7.fx = Tween.prototype.init;
      jQuery7.fx.step = {};
      ...
      function schedule() {
        if (inProgress) {
          if (document2.hidden === false && window2.requestAnimationFrame) {
            ...
            window2.setTimeout(schedule, jQuery7.fx.interval);
          }
          jQuery7.fx.tick();
        }
      }
      ...
      function defaultPrefilter(elem, props, opts) {
        ...
        if (!opts.queue) {
          hooks = jQuery7._queueHooks(elem, "fx");
          ...
          anim.always(function() {
            anim.always(function() {
              hooks.unqueued--;
              if (!jQuery7.queue(elem, "fx").length) {
                hooks.empty.fire();
              }
            });
          });
        ...
        for (prop in props) {
          ...
          if (rfxtypes.test(value)) {
            ...
            orig[prop] = dataShow && dataShow[prop] || jQuery7.style(elem, prop);
          }
        }
        propTween = !jQuery7.isEmptyObject(props);
        if (!propTween && jQuery7.isEmptyObject(orig)) {
          return;
        }
        if (isBox && elem.nodeType === 1) {
          ...
          display = jQuery7.css(elem, "display");
          if (display === "none") {
            if (restoreDisplay) {
          ...
          if (display === "inline" || display === "inline-block" && restoreDisplay != null) {
            if (jQuery7.css(elem, "float") === "none") {
              if (!propTween) {
                anim.done(function() {
        ...
        for (prop in orig) {
          if (!propTween) {
            ...
            anim.done(function() {
              ...
              for (prop in orig) {
                jQuery7.style(elem, prop, orig[prop]);
              }
            });
          }
      ...
      function Animation(elem, properties, options) {
        var result, stopped, index = 0, length = Animation.prefilters.length, deferred = jQuery7.Deferred().always(function() {
          delete tick.elem;
        }), tick = function() {
          if (stopped) {
            return false;
          ...
          elem,
          props: jQuery7.extend({}, properties),
          opts: jQuery7.extend(true, {
            specialEasing: {},
            easing: jQuery7.easing._default
          }, options),
        ...
        for (; index < length; index++) {
          ...
          if (result) {
            if (isFunction(result.stop)) {
              jQuery7._queueHooks(animation.elem, animation.opts.queue).stop = result.stop.bind(result);
            }
            return result;
          }
        }
        jQuery7.map(props, createTween, animation);
      ...
      jQuery7.Animation = jQuery7.extend(Animation, {
        tweeners: {
          "*": [function(prop, value) {
      ...
      jQuery7.speed = function(speed, easing, fn) {
        var opt = speed && typeof speed === "object" ? jQuery7.extend({}, speed) : {
        ...
        if (jQuery7.fx.off) {
          ...
          if (typeof opt.duration !== "number") {
            if (opt.duration in jQuery7.fx.speeds) {
              opt.duration = jQuery7.fx.speeds[opt.duration];
            } else {
              opt.duration = jQuery7.fx.speeds._default;
            }
          }
        }
        ...
        opt.complete = function() {
          ...
          if (opt.queue) {
            jQuery7.dequeue(this, opt.queue);
          }
        };
        return opt;
      };
      jQuery7.fn.extend({
        ...
        animate: function(prop, speed, easing, callback) {
          var empty = jQuery7.isEmptyObject(prop), optall = jQuery7.speed(speed, easing, callback), doAnimation = function() {
            var anim = Animation(this, jQuery7.extend({}, prop), optall);
        ...
        stop: function(type, clearQueue, gotoEnd) {
          ...
          return this.each(function() {
            var dequeue = true, index = type != null && type + "queueHooks", timers = jQuery7.timers, data = dataPriv.get(this);
            if (index) {
        ...
        finish: function(type) {
          ...
          return this.each(function() {
            var index, data = dataPriv.get(this), queue = data[type + "queue"], hooks = data[type + "queueHooks"], timers = jQuery7.timers, length = queue ? queue.length : 0;
            data.finish = true;
            jQuery7.queue(this, type, []);
            if (hooks && hooks.stop) {
      ...
      jQuery7.each(["toggle", "show", "hide"], function(_i, name) {
        var cssFn = jQuery7.fn[name];
        jQuery7.fn[name] = function(speed, easing, callback) {
      ...
      jQuery7.timers = [];
      jQuery7.fx.tick = function() {
        var timer, i2 = 0, timers = jQuery7.timers;
        fxNow = Date.now();
      ...
      jQuery7.fx.timer = function(timer) {
        jQuery7.timers.push(timer);
        jQuery7.fx.start();
      };
      jQuery7.fx.interval = 13;
      jQuery7.fx.start = function() {
        if (inProgress) {
          return;
        }
        inProgress = true;
      ...
      jQuery7.fn.delay = function(time, type) {
        time = jQuery7.fx ? jQuery7.fx.speeds[time] || time : time;
        type = type || "fx";
      ...
      var boolHook, attrHandle = jQuery7.expr.attrHandle;
      jQuery7.fn.extend({
        attr: function(name, value) {
          return access(this, jQuery7.attr, name, value, arguments.length > 1);
        },
        removeAttr: function(name) {
          return this.each(function() {
            jQuery7.removeAttr(this, name);
          });
        }
      });
      jQuery7.extend({
        attr: function(elem, name, value) {
          ...
          if (typeof elem.getAttribute === "undefined") {
            return jQuery7.prop(elem, name, value);
          }
          if (nType !== 1 || !jQuery7.isXMLDoc(elem)) {
            hooks = jQuery7.attrHooks[name.toLowerCase()] || (jQuery7.expr.match.bool.test(name) ? boolHook : void 0);
          }
          if (value !== void 0) {
            if (value === null) {
              jQuery7.removeAttr(elem, name);
              return;
            }
          ...
          ret = jQuery7.find.attr(elem, name);
      ...
      jQuery7.each(jQuery7.expr.match.bool.source.match(/\w+/g), function(_i, name) {
        var getter = attrHandle[name] || jQuery7.find.attr;
      ...
      jQuery7.fn.extend({
        prop: function(name, value) {
          return access(this, jQuery7.prop, name, value, arguments.length > 1);
        },
        removeProp: function(name) {
          return this.each(function() {
            delete this[jQuery7.propFix[name] || name];
          });
        }
      });
      jQuery7.extend({
        prop: function(elem, name, value) {
          ...
          if (nType !== 1 || !jQuery7.isXMLDoc(elem)) {
            name = jQuery7.propFix[name] || name;
            hooks = jQuery7.propHooks[name];
          }
          if (value !== void 0) {
            if (hooks && "set" in hooks && (ret = hooks.set(elem, value, name)) !== void 0) {
              return ret;
        ...
        propHooks: {
          tabIndex: {
            get: function(elem) {
              var tabindex = jQuery7.find.attr(elem, "tabindex");
              if (tabindex) {
      ...
      jQuery7.each([
        ...
        jQuery7.propFix[this.toLowerCase()] = this;
      });
      ...
      jQuery7.fn.extend({
        addClass: function(value) {
          ...
          if (isFunction(value)) {
            return this.each(function(j) {
              jQuery7(this).addClass(value.call(this, j, getClass(this)));
            });
          }
        ...
        removeClass: function(value) {
          ...
          if (isFunction(value)) {
            return this.each(function(j) {
              jQuery7(this).removeClass(value.call(this, j, getClass(this)));
            });
          }
          if (!arguments.length) {
      ...
      jQuery7.fn.extend({
        val: function(value) {
          ...
          if (!arguments.length) {
            if (elem) {
              hooks = jQuery7.valHooks[elem.type] || jQuery7.valHooks[elem.nodeName.toLowerCase()];
          ...
          return this.each(function(i2) {
            ...
            if (valueIsFunction) {
              val = value.call(this, i2, jQuery7(this).val());
            } else {
              val = value;
            }
            if (val == null) {
              ...
              val = jQuery7.map(val, function(value2) {
                return value2 == null ? "" : value2 + "";
              });
            }
            hooks = jQuery7.valHooks[this.type] || jQuery7.valHooks[this.nodeName.toLowerCase()];
      ...
      jQuery7.extend({
        valHooks: {
          option: {
            get: function(elem) {
              var val = jQuery7.find.attr(elem, "value");
              return val != null ? val : (
                // Support: IE <=10 - 11 only
                // option.text throws exceptions (trac-14686, trac-14858)
                // Strip and collapse whitespace
                // https://html.spec.whatwg.org/#strip-and-collapse-whitespace
                stripAndCollapse(jQuery7.text(elem))
              );
            }
          },
          select: {
            ...
            set: function(elem, value) {
              var optionSet, option, options = elem.options, values = jQuery7.makeArray(value), i2 = options.length;
              while (i2--) {
                option = options[i2];
                if (option.selected = jQuery7.inArray(jQuery7.valHooks.option.get(option), values) > -1) {
                  optionSet = true;
                }
              }
              if (!optionSet) {
      ...
      jQuery7.each(["radio", "checkbox"], function() {
        jQuery7.valHooks[this] = {
          set: function(elem, value) {
            if (Array.isArray(value)) {
              return elem.checked = jQuery7.inArray(jQuery7(elem).val(), value) > -1;
            }
          }
        };
        if (!support.checkOn) {
          jQuery7.valHooks[this].get = function(elem) {
      ...
      var rquery = /\?/;
      jQuery7.parseXML = function(data) {
        ...
        if (!xml || parserErrorElem) {
          jQuery7.error("Invalid XML: " + (parserErrorElem ? jQuery7.map(parserErrorElem.childNodes, function(el) {
      ...
      jQuery7.extend(jQuery7.event, {
        trigger: function(event, data, elem, onlyHandlers) {
          ...
          if (rfocusMorph.test(type + jQuery7.event.triggered)) {
            return;
          }
          if (type.indexOf(".") > -1) {
          ...
          event = event[jQuery7.expando] ? event : new jQuery7.Event(type, typeof event === "object" && event);
          ...
          data = data == null ? [event] : jQuery7.makeArray(data, [event]);
          special = jQuery7.event.special[type] || {};
          ...
          if (!onlyHandlers && !event.isDefaultPrevented()) {
            if ((!special._default || special._default.apply(eventPath.pop(), data) === false) && acceptData(elem)) {
              if (ontype && isFunction(elem[type]) && !isWindow(elem)) {
                ...
                jQuery7.event.triggered = void 0;
                if (tmp) {
                  elem[ontype] = tmp;
                }
              }
        ...
        simulate: function(type, elem, event) {
          ...
          jQuery7.event.trigger(e, null, elem);
        }
      });
      jQuery7.fn.extend({
        trigger: function(type, data) {
          return this.each(function() {
            jQuery7.event.trigger(type, data, this);
          });
        },
        triggerHandler: function(type, data) {
          var elem = this[0];
          if (elem) {
            return jQuery7.event.trigger(type, data, elem, true);
          }
        }
      });
      ...
      function buildParams(prefix, obj, traditional, add) {
        ...
        if (Array.isArray(obj)) {
          jQuery7.each(obj, function(i2, v) {
      ...
      jQuery7.param = function(a, traditional) {
        ...
        if (Array.isArray(a) || a.jquery && !jQuery7.isPlainObject(a)) {
          jQuery7.each(a, function() {
      ...
      jQuery7.fn.extend({
        serialize: function() {
          return jQuery7.param(this.serializeArray());
        },
        serializeArray: function() {
          return this.map(function() {
            var elements = jQuery7.prop(this, "elements");
            return elements ? jQuery7.makeArray(elements) : this;
          }).filter(function() {
            var type = this.type;
            return this.name && !jQuery7(this).is(":disabled") && rsubmittable.test(this.nodeName) && !rsubmitterTypes.test(type) && (this.checked || !rcheckableType.test(type));
          }).map(function(_i, elem) {
            var val = jQuery7(this).val();
            if (val == null) {
              return null;
            }
            if (Array.isArray(val)) {
              return jQuery7.map(val, function(val2) {
      ...
      function inspectPrefiltersOrTransports(structure, options, originalOptions, jqXHR) {
        ...
        function inspect(dataType) {
          ...
          jQuery7.each(structure[dataType] || [], function(_, prefilterOrFactory) {
      ...
      function ajaxExtend(target, src) {
        var key, deep, flatOptions = jQuery7.ajaxSettings.flatOptions || {};
        for (key in src) {
          if (src[key] !== void 0) {
        ...
        if (deep) {
          jQuery7.extend(true, target, deep);
        }
        return target;
      }
      ...
      jQuery7.extend({
        ...
        ajaxSetup: function(target, settings) {
          return settings ? (
            ...
            ajaxExtend(ajaxExtend(target, jQuery7.ajaxSettings), settings)
          ) : (
            // Extending ajaxSettings
            ajaxExtend(jQuery7.ajaxSettings, target)
          );
        },
        ...
        ajax: function(url, options) {
          ...
          options = options || {};
          var transport, cacheURL, responseHeadersString, responseHeaders, timeoutTimer, urlAnchor, completed2, fireGlobals, i2, uncached, s = jQuery7.ajaxSetup({}, options), callbackContext = s.context || s, globalEventContext = s.context && (callbackContext.nodeType || callbackContext.jquery) ? jQuery7(callbackContext) : jQuery7.event, deferred = jQuery7.Deferred(), completeDeferred = jQuery7.Callbacks("once memory"), statusCode = s.statusCode || {}, requestHeaders = {}, requestHeadersNames = {}, strAbort = "canceled", jqXHR = {
            readyState: 0,
          ...
          if (s.data && s.processData && typeof s.data !== "string") {
            s.data = jQuery7.param(s.data, s.traditional);
          }
          inspectPrefiltersOrTransports(prefilters, s, options, jqXHR);
          if (completed2) {
            return jqXHR;
          }
          fireGlobals = jQuery7.event && s.global;
          if (fireGlobals && jQuery7.active++ === 0) {
            jQuery7.event.trigger("ajaxStart");
          }
          ...
          if (s.ifModified) {
            if (jQuery7.lastModified[cacheURL]) {
              jqXHR.setRequestHeader("If-Modified-Since", jQuery7.lastModified[cacheURL]);
            }
            if (jQuery7.etag[cacheURL]) {
              jqXHR.setRequestHeader("If-None-Match", jQuery7.etag[cacheURL]);
            }
          }
          ...
          function done(status, nativeStatusText, responses, headers) {
            ...
            if (!isSuccess && jQuery7.inArray("script", s.dataTypes) > -1 && jQuery7.inArray("json", s.dataTypes) < 0) {
            ...
            if (isSuccess) {
              if (s.ifModified) {
                ...
                if (modified) {
                  jQuery7.lastModified[cacheURL] = modified;
                }
                modified = jqXHR.getResponseHeader("etag");
                if (modified) {
                  jQuery7.etag[cacheURL] = modified;
                }
              }
            ...
            if (fireGlobals) {
              ...
              if (!--jQuery7.active) {
                jQuery7.event.trigger("ajaxStop");
              }
            }
          }
          return jqXHR;
        ...
        getJSON: function(url, data, callback) {
          return jQuery7.get(url, data, callback, "json");
        },
        getScript: function(url, callback) {
          return jQuery7.get(url, void 0, callback, "script");
        }
      });
      jQuery7.each(["get", "post"], function(_i, method) {
        jQuery7[method] = function(url, data, callback, type) {
          if (isFunction(data)) {
            type = type || callback;
            callback = data;
            data = void 0;
          }
          return jQuery7.ajax(jQuery7.extend({
            url,
            type: method,
            dataType: type,
            data,
            success: callback
          }, jQuery7.isPlainObject(url) && url));
        };
      });
      jQuery7.ajaxPrefilter(function(s) {
        var i2;
        for (i2 in s.headers) {
      ...
      jQuery7._evalUrl = function(url, options, doc) {
        return jQuery7.ajax({
          url,
          ...
          dataFilter: function(response) {
            jQuery7.globalEval(response, options, doc);
          }
        });
      };
      jQuery7.fn.extend({
        wrapAll: function(html) {
          ...
          if (this[0]) {
            ...
            wrap = jQuery7(html, this[0].ownerDocument).eq(0).clone(true);
        ...
        wrapInner: function(html) {
          if (isFunction(html)) {
            return this.each(function(i2) {
              jQuery7(this).wrapInner(html.call(this, i2));
            });
          }
          return this.each(function() {
            var self = jQuery7(this), contents = self.contents();
            if (contents.length) {
        ...
        wrap: function(html) {
          ...
          return this.each(function(i2) {
            jQuery7(this).wrapAll(htmlIsFunction ? html.call(this, i2) : html);
          });
        },
        unwrap: function(selector) {
          this.parent(selector).not("body").each(function() {
            jQuery7(this).replaceWith(this.childNodes);
          });
          return this;
        }
      });
      jQuery7.expr.pseudos.hidden = function(elem) {
        return !jQuery7.expr.pseudos.visible(elem);
      };
      jQuery7.expr.pseudos.visible = function(elem) {
        return !!(elem.offsetWidth || elem.offsetHeight || elem.getClientRects().length);
      };
      jQuery7.ajaxSettings.xhr = function() {
        try {
      ...
      var xhrSuccessStatus = {
        ...
        1223: 204
      }, xhrSupported = jQuery7.ajaxSettings.xhr();
      support.cors = !!xhrSupported && "withCredentials" in xhrSupported;
      support.ajax = xhrSupported = !!xhrSupported;
      jQuery7.ajaxTransport(function(options) {
      ...
      jQuery7.ajaxSetup({
        ...
        converters: {
          "text script": function(text) {
            jQuery7.globalEval(text);
            return text;
          }
        }
      });
      jQuery7.ajaxPrefilter("script", function(s) {
        if (s.cache === void 0) {
          s.cache = false;
        }
        if (s.crossDomain) {
      ...
      jQuery7.ajaxTransport("script", function(s) {
        if (s.crossDomain || s.scriptAttrs) {
          var script, callback;
          return {
            send: function(_, complete) {
              script = jQuery7("<script>").attr(s.scriptAttrs || {}).prop({ charset: s.scriptCharset, src: s.url }).on("load error", callback = function(evt) {
                script.remove();
                callback = null;
                if (evt) {
      ...
      jQuery7.ajaxSetup({
        ...
        jsonpCallback: function() {
          var callback = oldCallbacks.pop() || jQuery7.expando + "_" + nonce.guid++;
          this[callback] = true;
          return callback;
        }
      });
      jQuery7.ajaxPrefilter("json jsonp", function(s, originalSettings, jqXHR) {
        ...
        if (jsonProp || s.dataTypes[0] === "jsonp") {
          ...
          s.converters["script json"] = function() {
            if (!responseContainer) {
              jQuery7.error(callbackName + " was not called");
            }
          ...
          jqXHR.always(function() {
            if (overwritten === void 0) {
              jQuery7(window2).removeProp(callbackName);
            } else {
      ...
      jQuery7.parseHTML = function(data, context, keepScripts) {
        if (typeof data !== "string") {
          return [];
        }
        ...
        if (scripts && scripts.length) {
          jQuery7(scripts).remove();
        }
        return jQuery7.merge([], parsed.childNodes);
      };
      jQuery7.fn.load = function(url, params, callback) {
        ...
        if (self.length > 0) {
          jQuery7.ajax({
            ...
            self.html(selector ? (
              ...
              jQuery7("<div>").append(jQuery7.parseHTML(responseText)).find(selector)
            ) : (
      ...
      jQuery7.expr.pseudos.animated = function(elem) {
        return jQuery7.grep(jQuery7.timers, function(fn) {
          return elem === fn.elem;
        }).length;
      };
      jQuery7.offset = {
        setOffset: function(elem, options, i2) {
          var curPosition, curLeft, curCSSTop, curTop, curOffset, curCSSLeft, calculatePosition, position = jQuery7.css(elem, "position"), curElem = jQuery7(elem), props = {};
          if (position === "static") {
            elem.style.position = "relative";
          }
          curOffset = curElem.offset();
          curCSSTop = jQuery7.css(elem, "top");
          curCSSLeft = jQuery7.css(elem, "left");
          ...
          if (isFunction(options)) {
            options = options.call(elem, i2, jQuery7.extend({}, curOffset));
          }
          if (options.top != null) {
      ...
      jQuery7.fn.extend({
        ...
        offset: function(options) {
          if (arguments.length) {
            return options === void 0 ? this : this.each(function(i2) {
              jQuery7.offset.setOffset(this, options, i2);
            });
          }
        ...
        position: function() {
          ...
          if (jQuery7.css(elem, "position") === "fixed") {
            offset = elem.getBoundingClientRect();
          } else {
            offset = this.offset();
            doc = elem.ownerDocument;
            offsetParent = elem.offsetParent || doc.documentElement;
            while (offsetParent && (offsetParent === doc.body || offsetParent === doc.documentElement) && jQuery7.css(offsetParent, "position") === "static") {
              offsetParent = offsetParent.parentNode;
            }
            if (offsetParent && offsetParent !== elem && offsetParent.nodeType === 1) {
              parentOffset = jQuery7(offsetParent).offset();
              parentOffset.top += jQuery7.css(offsetParent, "borderTopWidth", true);
              parentOffset.left += jQuery7.css(offsetParent, "borderLeftWidth", true);
            }
          }
          return {
            top: offset.top - parentOffset.top - jQuery7.css(elem, "marginTop", true),
            left: offset.left - parentOffset.left - jQuery7.css(elem, "marginLeft", true)
          };
        },
        ...
        offsetParent: function() {
          return this.map(function() {
            ...
            while (offsetParent && jQuery7.css(offsetParent, "position") === "static") {
      ...
      jQuery7.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(method, prop) {
        var top = "pageYOffset" === prop;
        jQuery7.fn[method] = function(val) {
      ...
      jQuery7.each(["top", "left"], function(_i, prop) {
        jQuery7.cssHooks[prop] = addGetHookIf(
          support.pixelPosition,
          function(elem, computed) {
            if (computed) {
              computed = curCSS(elem, prop);
              return rnumnonpx.test(computed) ? jQuery7(elem).position()[prop] + "px" : computed;
            }
          }
        );
      });
      jQuery7.each({ Height: "height", Width: "width" }, function(name, type) {
        jQuery7.each({
          padding: "inner" + name,
          content: type,
          "": "outer" + name
        }, function(defaultExtra, funcName) {
          jQuery7.fn[funcName] = function(margin, value) {
            ...
            return access(this, function(elem, type2, value2) {
              ...
              return value2 === void 0 ? (
                ...
                jQuery7.css(elem, type2, extra)
              ) : (
                // Set width or height on the element
                jQuery7.style(elem, type2, value2, extra)
              );
      ...
      jQuery7.each(
        ...
        function(_i, name) {
          jQuery7.fn[name] = function(data, fn) {
            return arguments.length > 0 ? this.on(name, null, data, fn) : this.trigger(name);
          };
        }
      );
      var rtrim = /^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;
      jQuery7.proxy = function(fn, context) {
        var tmp, args, proxy;
        ...
        proxy.guid = fn.guid = fn.guid || jQuery7.guid++;
        return proxy;
      };
      jQuery7.holdReady = function(hold) {
        if (hold) {
          jQuery7.readyWait++;
        } else {
          jQuery7.ready(true);
      ...
      jQuery7.isArray = Array.isArray;
      jQuery7.parseJSON = JSON.parse;
      jQuery7.nodeName = nodeName;
      jQuery7.isFunction = isFunction;
      jQuery7.isWindow = isWindow;
      jQuery7.camelCase = camelCase;
      jQuery7.type = toType;
      jQuery7.now = Date.now;
      jQuery7.isNumeric = function(obj) {
        var type = jQuery7.type(obj);
        return (type === "number" || type === "string") && // parseFloat NaNs numeric-cast false positives ("")
        // ...but misinterprets leading-number strings, particularly hex literals ("0x...")
        // subtraction forces infinities to NaN
        !isNaN(obj - parseFloat(obj));
      };
      jQuery7.trim = function(text) {
      ...
      jQuery7.noConflict = function(deep) {
        if (window2.$ === jQuery7) {
          window2.$ = _$;
        }
        if (deep && window2.jQuery === jQuery7) {
          window2.jQuery = _jQuery;
        }
        return jQuery7;
      };
      if (typeof noGlobal === "undefined") {
        window2.jQuery = window2.$ = jQuery7;
      }
      return jQuery7;
    });
  }
...
var Buttons = function(dt, config) {
  ...
  this.c = $4.extend(true, {}, Buttons.defaults, config);
  if (config.buttons) {
  ...
  this.dom = {
    container: $4("<" + this.c.dom.container.tag + "/>").addClass(this.c.dom.container.className)
  };
  this._constructor();
};
$4.extend(Buttons.prototype, {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   * Public methods
   */
  /**
  ...
  */
  ...
  processing: function(node, flag) {
    ...
    $4(dt.table().node()).triggerHandler("buttons-processing.dt", [
      flag,
      dt.button(node),
      dt,
      $4(node),
  ...
  remove: function(node) {
    ...
    if (button.conf.destroy) {
      button.conf.destroy.call(dt.button(node), dt, $4(node), button.conf);
    }
  ...
  */
  ...
  _constructor: function() {
    ...
    $4("body").on("keyup." + this.s.namespace, function(e) {
  ...
  _expandButton: function(attachTo, button, split, inCollection, inSplit, attachPoint, parentConf) {
    ...
    for (var i2 = 0, ien = buttons.length; i2 < ien; i2++) {
      ...
      if (built.conf.buttons) {
        built.collection = $4("<" + domCollection.container.content.tag + "/>");
        built.conf._collection = built.collection;
        $4(built.node).append(domCollection.action.dropHtml);
        this._expandButton(
          built.buttons,
          built.conf.buttons,
          built.conf.split,
      ...
      if (conf.init) {
        conf.init.call(dt.button(built.node), dt, $4(built.node), conf);
      }
    }
  },
  /**
  ...
  _buildButton: function(config, inCollection, isSplit, inSplit) {
    ...
    if (config.spacer) {
      var spacer = $4("<" + dom.spacer.tag + "/>").addClass("dt-button-spacer " + config.style + " " + dom.spacer.className).html(text(config.text));
      return {
        conf: config,
        node: spacer,
        inserter: spacer,
    ...
    if (!config.hasOwnProperty("html")) {
      var action = function(e, dt2, button2, config2) {
        ...
        $4(dt2.table().node()).triggerHandler("buttons-action.dt", [
          dt2.button(button2),
          dt2,
          button2,
          config2
      ...
      button = $4("<" + tag + "/>").addClass(dom.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(e) {
        e.preventDefault();
      ...
      if (dom.liner.tag) {
        var liner = $4("<" + dom.liner.tag + "/>").html(text(config.text)).addClass(dom.liner.className);
    ...
    if (isSplit) {
      ...
      var dropButtonConfig = $4.extend(config, {
  ...
  _popover: function(content, hostButton, inOpts, e) {
    ...
    var close = function() {
      ...
      $4(dt.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes()).attr(
        "aria-expanded",
        "false"
      );
    ...
    if (position === "absolute") {
      ...
      if (containerPosition.left + left + popoverSizes.width > $4(window).width()) {
        left = $4(window).width() - popoverSizes.width - containerPosition.left;
      }
      if (buttonOffset.left + left < 0) {
        left = -buttonOffset.left;
      }
      if (containerPosition.top + top + popoverSizes.height > $4(window).height() + $4(window).scrollTop()) {
        top = buttonPosition.top - popoverSizes.height - popoverSizes.marginTop - popoverSizes.marginBottom;
      }
      if (containerPosition.top + top < $4(window).scrollTop()) {
    ...
    $4("div.dt-button-background").on("click.dtb-collection", function() {
    });
    ...
    setTimeout(function() {
      ...
      $4("body").on("click.dtb-collection", function(e2) {
        ...
        var elements = $4("a, button", content);
...
Buttons.instanceSelector = function(group, buttons) {
  if (group === void 0 || group === null) {
    return $4.map(buttons, function(v) {
      return v.inst;
    });
  }
  var ret = [];
  var names = $4.map(buttons, function(v) {
    return v.name;
  });
...
Buttons.buttonSelector = function(insts, selector) {
  ...
  var run = function(selector2, inst2) {
    ...
    var nodes = $4.map(buttons, function(v) {
      return v.node;
    });
    ...
    if (selector2 === null || selector2 === void 0 || selector2 === "*") {
      ...
      if (selector2.indexOf(",") !== -1) {
        ...
        var indexes = $4.map(buttons, function(v) {
          return v.idx;
        });
        ret.push({
          inst: inst2,
...
$4.extend(_dtButtons, {
  collection: {
    ...
    action: function(e, dt, button, config) {
      ...
      if (e.type === "keypress") {
        $4("a, button", config._collection).eq(0).focus();
      }
    },
    attr: {
      "aria-haspopup": "dialog"
  ...
  pageLength: function(dt) {
    ...
    return {
      ...
      autoClose: true,
      buttons: $4.map(vals, function(val, i3) {
        return {
          text: lang[i3],
...
jquery_dataTables_default.Api.register("buttons.info()", function(title, message, time) {
  ...
  _fadeIn(
    $4('<div id="datatables_buttons_info" class="dt-button-info"/>').html(title).append($4("<div/>")[typeof message === "string" ? "html" : "append"](message)).css("display", "none").appendTo("body")
  );
...
var _filename = function(config) {
  ...
  if (filename.indexOf("*") !== -1) {
    filename = filename.replace("*", $4("head > title").text()).trim();
  }
...
var _title = function(config) {
  ...
  return title === null ? null : title.indexOf("*") !== -1 ? title.replace("*", $4("head > title").text() || "Exported data") : title;
};
var _message = function(dt, option, position) {
  ...
  var caption = $4("caption", dt.table().container()).eq(0);
  if (message === "*") {
...
var _exportData = function(dt, inOpts) {
  ...
  var modifier = $4.extend({}, config.modifier);
  if (dt.select && typeof dt.select.info === "function" && modifier.selected === void 0) {
    if (dt.rows(config.rows, $4.extend({ selected: true }, modifier)).any()) {
...
$4.fn.dataTable.Buttons = Buttons;
$4.fn.DataTable.Buttons = Buttons;
$4(document).on("init.dt plugin-init.dt", function(e, settings) {
  if (e.namespace !== "dt") {
    return;
  }
...
// node_modules/datatables.net-buttons-bs5/js/buttons.bootstrap5.mjs
var $5 = import_jquery4.default;
$5.extend(true, dataTables_bootstrap5_default.Buttons.defaults, {
  dom: {
    container: {
  ...
  buttonCreated: function(config, button) {
    return config.buttons ? $5('<div class="btn-group"/>').append(button) : button;
  }
});
...
var $6 = import_jquery5.default;
jquery_dataTables_default.select = {};
jquery_dataTables_default.select.version = "1.7.0";
...
function enableMouseSelection(dt) {
  ...
  $6("body").on("click.dtSelect" + _safeId(dt.table().node()), function(e) {
    if (ctx._select.blurable) {
      ...
      var event = $6.Event("select-blur.dt");
...
function info(api) {
  ...
  var add = function(el, name, num) {
    el.append(
      $6('<span class="select-item"/>').append(
        api.i18n(
          "select." + name + "s",
  ...
  $6.each(ctx.aanFeatures.i, function(i2, el) {
    el = $6(el);
...
function init(ctx) {
    ...
    fn: function(row, data, index) {
      ...
      for (i2 = 0, ien = ctx.aoColumns.length; i2 < ien; i2++) {
        if (ctx.aoColumns[i2]._select_selected || d._selected_cells && d._selected_cells[i2]) {
          $6(d.anCells[i2]).addClass(ctx._select.className);
        }
      }
    },
  ...
  api.on("destroy.dtSelect", function() {
    $6(api.rows({ selected: true }).nodes()).removeClass(api.settings()[0]._select.className);
...
$6.extend(jquery_dataTables_default.ext.buttons, {
  selected: {
...
$6.each(["Row", "Column", "Cell"], function(i2, item) {
...
$6.fn.DataTable.select = jquery_dataTables_default.select;
$6(document).on("preInit.dt.dtSelect", function(e, ctx) {
  if (e.namespace !== "dt") {
    return;
  }
  jquery_dataTables_default.select.init(new jquery_dataTables_default.Api(ctx));
